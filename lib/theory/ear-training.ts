...
/**
 * Toca uma única nota aleatória (na afinação concertante real) e pede pra identificar o nome
 * que o sax alto (afinado em Mi♭) usaria pra essa nota — ou seja, a nota transposta.
 */
